...
export default class ArysGetRequest {
    ...
    create = ({ activeProject, activePage, activeSort, filters, MAX_ARYS_PER_REQUEST }) => {
        ...
        const leadRequestOffset = (activePage - 1) * MAX_ARYS_PER_REQUEST;
        const leadRequestLimit = MAX_ARYS_PER_REQUEST;

        // TODO: VAGUE add required fields only
        const urlForProjectLeads = createUrlForArysOfProject({
