const initialDomainDataState = {
    leads: [
        ...
        },
        {
            id: 6,
            createdOn: 78923230239,
            createdBy: 'Sameer Shakten Rai (Ale)',
            title: 'If everyone was Kung fu fighting, and their kicks really were fast as lightning, what would happen?',
            published: 981274203420,
            confidentiality: 'Public',
            source: 'News that moves',
            numberOfEntries: 6,
    ...
    users: {
        14: {
            ...
            projects: [
                {
                    id: 1,
                    title: 'Antigua and Barbuda Global Monitoring',
                    members: [14],
                    regions: [],
                    memberships: [1],
                    userGroups: [],
                ...
                {
                    id: 2,
                    title: 'French Polynesia Global Monitoring',
                    members: [14],
                    regions: [],
                    memberships: [1],
                    userGroups: [],
